...
\title{OrganoidVision: Bio-Hybrid Retinal Organoids as Living Event-Based Imaging Sensors}
...
\section*{Repository Relationship}
This manuscript is released through the OrganoidVision repository. The companion OrganoidIntelligence repository provides the broader brain-organoid-on-chip resource map, bioelectronic interface strategy, and first-demo roadmap that frames OrganoidVision as the retinal sensing branch of the larger wetware-computing program.\cite{organoidintelligence2026}

\section*{Code Availability}
Custom code for event detection, spike sorting, neuromorphic decoding, and manuscript assets is released through the public OrganoidVision repository at \url{https://github.com/lachlanchen/OrganoidVision}.
...
\bibitem{organoidintelligence2026} Chen, L. \& AgInTiFlow. Organoid Brain-on-a-Chip Systems: Resource Map, Bioelectronic Interface Strategy and First-Demo Roadmap. OrganoidIntelligence repository (2026). \url{https://github.com/lachlanchen/OrganoidIntelligence}
\end{thebibliography}
